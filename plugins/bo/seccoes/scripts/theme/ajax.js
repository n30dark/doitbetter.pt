...
function processData( xmlHttp, intID )
{
  ...
  {
    case 99:        //zipper
      zipnext(xmlHttp.responseText);
      break;
    case 98:        //unzipper
      start2unpack(xmlHttp.responseText);
      break;
    case 89:        //texteditor: request for amount of lines
      got_lines(xmlHttp.responseText);
      break;
    case 88:        //texteditor: request for amount of lines
      got_text(xmlHttp.responseText);
      break;
    case 87:        //texteditor: request to save document
      save_send_piece(xmlHttp.responseText);
      break;
	case 79:		//search: starts search
	  FV_search_startback(xmlHttp.responseText);
	  break;
    default:	// 
