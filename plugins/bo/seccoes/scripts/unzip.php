...
function selectf()
{
  ...
  for(i=0;i<3;i++)
  {
    for(y=1;y<=4;y++)
      if(y!=3)
        chmv+=multiplier*(document.getElementById('chm'+(multiplier*y)).checked?y:0);
    multiplier*=10;
  }
  window.opener.chmodsel_onselect(chmv.toString().substr(1) );
  window.close();
}
//-->
</script>
...
<form name="chmod" method="get" action="explorer_menu.php">
<table border="0" cellspacing="0" cellpadding="1">
  ...
  <tr>
    <td align="center" colspan="4"><input type="button" onClick="selectf()" class="button" value="<?php echo $l_chm_save; ?>"/></td>
  </tr>
</table>
